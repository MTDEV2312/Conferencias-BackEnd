...
const RegisterSpeakerValidator =[
    body('cedula')
        .trim()
...
export {
    RegisterSpeakerValidator,
    GetSpeakerByIdValidator,
    UpdateSpeakerValidator,
    DeleteSpeakerValidator
}
